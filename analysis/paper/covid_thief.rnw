...
<<location_plot, echo=FALSE, fig=TRUE, height=12, width=10>>=
...
table_last17_states <- tar_read(last17_validation_states, store="../../_targets") %>%
  xtable(digits=c(rep(0, 2), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the last 17 weeks of the validation phase for averaged states, ordered by ascending WIS", label="tab:table_last17_states")
...
table_last17_states <- tar_read(last17_validation_states, store="../../_targets") %>%
  xtable(digits=c(rep(0, 1), rep(2, 6)), auto=TRUE)
...
table_last17_us <- tar_read(last17_validation_us, store="../../_targets") %>%
  xtable(digits=c(rep(0, 2), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the last 17 weeks of the validation phase for U.S. national, ordered by ascending WIS", label="tab:table_last17_us")
...
<<echo=FALSE, eval=FALSE, results=tex>>=
table_last17_us <- tar_read(last17_validation_us, store="../../_targets") %>%
  xtable(digits=c(0, rep(1, 3), rep(2, 6)))
...
table_horizon_states <- tar_read(horizon_metrics_states, store="../../_targets") %>%
  ...
  xtable(digits=c(rep(0, 3), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the testing phase stratified by horizon week for averaged states, ordered by ascending WIS", label="tab:table_horizon_states")
...
table_horizon_us <- tar_read(horizon_metrics_us, store="../../_targets") %>%
  rename(`Hzn` = horizon_wk) %>%
  xtable(digits=c(rep(0, 3), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the testing phase stratified by horizon week for U.S. national, ordered by ascending WIS", label="tab:table_horizon_us")
...
table_horizon_us <- tar_read(horizon_metrics_us, store="../../_targets") %>%
  rename(`Hzn` = horizon_wk) %>%
  xtable(digits=c(rep(0, 3), rep(2, 4)))
...
table_wave_states <- tar_read(wave_metrics_states, store="../../_targets") %>%
  ...
  xtable(digits=c(rep(0, 4), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the testing phase stratified by pandemic wave and horizon week for averaged states, ordered by ascending WIS", label="tab:table_wave_states")
...
table_wave_states <- tar_read(wave_metrics_states, store="../../_targets") %>%
  ...
  rename(`Hzn` = horizon_wk, `Wave` = wave) %>%
  xtable(digits=c(rep(0, 4), rep(2, 6)))
print(table_wave_states, booktabs=FALSE, tabular.environment='longtable', caption.placement = "top", floating=FALSE, include.rownames=FALSE, size="\\renewcommand{\\arraystretch}{0.75} \\setlength{\\tabcolsep}{3pt}")
@
...
table_wave_us <- tar_read(wave_metrics_us, store="../../_targets") %>%
  ...
  rename(`Hzn` = horizon_wk, `Wave` = wave) %>%
  xtable(digits=c(rep(0, 4), rep(2, 6)), auto=TRUE, caption = "Summary of model performance during the testing phase stratified by pandemic wave and horizon week for U.S. national, ordered by ascending WIS", label="tab:table_wave_us")
...
table_wave_us <- tar_read(wave_metrics_us, store="../../_targets") %>%
  rename(`Hzn` = horizon_wk) %>%
  xtable(digits=c(rep(0, 4), rep(2, 6)), auto=TRUE)
