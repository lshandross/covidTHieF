...
For the by-location evaluation the top seven models had better or equivalent performance to the COVIDhub-baseline (Figure \ref{fig:figure_location_plot}). The COVIDhub-4\_week\_ensemble was first place yet again for the evaluation while the other top models demonstrated close WIS values across all locations. CU-select also performed very well, beating the COVIDhub-4\_week\_ensemble by more than 0.05 relative WIS in over 18\% of locations. THieF\_6wk-4root (third place) was marginally better than the four models ranked below it with lower relative WIS by a difference of more than 0.05 in over 18\% of locations. THieF\_12wk-4root (ranked fourth) had several locations for which it outperformed the COVIDhub-4\_week\_ensemble, CU-select, THieF\_6wk-4root (Figure \ref{fig:figure_location_plot}).
