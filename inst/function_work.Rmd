...
aggregate_thief_df <- 
  function(df, ts_col = "value", start_date, end_date, fips_code, aggregate_levels = list(56, 28, 14, 7, 1), frequency = 56) {
    ...
    hosp_truth <- df %>%
      ...
      ht_day_ts_ <- ts(hosp_truth[ts_col], start = c(1, 1), end = c(periods+1, remainder), frequency = freq)
...
aggregate_thief_df(full_hosp_truth, ts_col = "value", start_date, end_date, fips_code, aggregate_levels = list(56, 28, 14, 7, 1), frequency = 56) 
```   
