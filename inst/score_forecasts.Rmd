...
overall_metrics_US <- scores_df %>%
  ...
  mutate(
    ...
    rcov_50 = case_when(
      horizon_wk == 1 ~ (coverage_50-0.5) / abs(pull(overall_metrics_US[9,5])-0.5),
      horizon_wk == 2 ~ (coverage_50-0.5) / abs(pull(overall_metrics_US[10,5])-0.5),
      horizon_wk == 3 ~ (coverage_50-0.5) / abs(pull(overall_metrics_US[11,5])-0.5),
      horizon_wk == 4 ~ (coverage_50-0.5) / abs(pull(overall_metrics_US[12,5])-0.5),
    ),
    rcov_95 = case_when(
      horizon_wk == 1 ~ (coverage_95-0.95) / abs(pull(overall_metrics_US[9,6])-0.95),
      horizon_wk == 2 ~ (coverage_95-0.95) / abs(pull(overall_metrics_US[10,6])-0.95),
      horizon_wk == 3 ~ (coverage_95-0.95) / abs(pull(overall_metrics_US[11,6])-0.95),
      horizon_wk == 4 ~ (coverage_95-0.95) / abs(pull(overall_metrics_US[12,6])-0.95),
    )
  )
...
overall_metrics_states <- scores_df %>%
  ...
  mutate(
    ...
    rcov_50 = case_when(
      horizon_wk == 1 ~ (coverage_50-0.5) / abs(pull(overall_metrics_states[9,5])-0.5),
      horizon_wk == 2 ~ (coverage_50-0.5) / abs(pull(overall_metrics_states[10,5])-0.5),
      horizon_wk == 3 ~ (coverage_50-0.5) / abs(pull(overall_metrics_states[11,5])-0.5),
      horizon_wk == 4 ~ (coverage_50-0.5) / abs(pull(overall_metrics_states[12,5])-0.5),
    ),
    rcov_95 = case_when(
      horizon_wk == 1 ~ (coverage_95-0.95) / abs(pull(overall_metrics_states[9,6])-0.95),
      horizon_wk == 2 ~ (coverage_95-0.95) / abs(pull(overall_metrics_states[10,6])-0.95),
      horizon_wk == 3 ~ (coverage_95-0.95) / abs(pull(overall_metrics_states[11,6])-0.95),
      horizon_wk == 4 ~ (coverage_95-0.95) / abs(pull(overall_metrics_states[12,6])-0.95),
    )
  )
...
wave_metrics_US <- scores_df %>%
  ...
  mutate(
    ...
    rcov_50 = case_when(
      horizon_wk == 1 ~ (coverage_50-0.5) / abs(pull(wave_metrics_US[9,6])-0.5),
      horizon_wk == 2 ~ (coverage_50-0.5) / abs(pull(wave_metrics_US[10,6])-0.5),
      horizon_wk == 3 ~ (coverage_50-0.5) / abs(pull(wave_metrics_US[11,6])-0.5),
      horizon_wk == 4 ~ (coverage_50-0.5) / abs(pull(wave_metrics_US[12,6])-0.5),
    ),
    rcov_95 = case_when(
      horizon_wk == 1 ~ (coverage_95-0.95) / abs(pull(wave_metrics_US[9,7])-0.95),
      horizon_wk == 2 ~ (coverage_95-0.95) / abs(pull(wave_metrics_US[10,7])-0.95),
      horizon_wk == 3 ~ (coverage_95-0.95) / abs(pull(wave_metrics_US[11,7])-0.95),
      horizon_wk == 4 ~ (coverage_95-0.95) / abs(pull(wave_metrics_US[12,7])-0.95),
    )
  )
...
wave_metrics_states <- scores_df %>%
  ...
  mutate(
    ...
    rcov_50 = case_when(
      horizon_wk == 1 & wave == "alpha" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[9,6])-0.5),
      horizon_wk == 2 & wave == "alpha" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[10,6])-0.5),
      horizon_wk == 3 & wave == "alpha" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[11,6])-0.5),
      horizon_wk == 4 & wave == "alpha" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[12,6])-0.5),
      horizon_wk == 1 & wave == "winter21" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[37,6])-0.5),
      horizon_wk == 2 & wave == "winter21" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[38,6])-0.5),
      horizon_wk == 3 & wave == "winter21" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[39,6])-0.5),
      horizon_wk == 4 & wave == "winter21" ~ (coverage_50-0.5) / abs(pull(wave_metrics_states[40,6])-0.5)
    ),
    rcov_95 = case_when(
      horizon_wk == 1 & wave == "alpha" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[9,7])-0.95),
      horizon_wk == 2 & wave == "alpha" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[10,7])-0.95),
      horizon_wk == 3 & wave == "alpha" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[11,7])-0.95),
      horizon_wk == 4 & wave == "alpha" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[12,7])-0.95),
      horizon_wk == 1 & wave == "winter21" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[37,7])-0.95),
      horizon_wk == 2 & wave == "winter21" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[38,7])-0.95),
      horizon_wk == 3 & wave == "winter21" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[39,7])-0.95),
      horizon_wk == 4 & wave == "winter21" ~ (coverage_95-0.95) / abs(pull(wave_metrics_states[40,7])-0.95)
    )
  )
...
# 95% PI Coverage
ggplot(filter(forecast_date_metrics_US, horizon_wk == 1), 
        aes(x = forecast_date + weeks(1), y = coverage_95)) +
  geom_line(aes(color=model)) +
  geom_point(aes(color=model)) +
